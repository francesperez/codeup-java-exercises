...
//====================================== throwing exceptions======================================================
//Exceptions are tools that handle errors. There is usually a message that describes what went wrong. Exceptions are
// thrown when an application can't perform an operation.

//        throw SomeException("Exception message here");
//        try {
//            throw new RuntimeException("You did something wrong. Sorry...");
//        } catch(Exception e){  // e is just a variable name for an object
//            e.printStackTrace();
//        }
